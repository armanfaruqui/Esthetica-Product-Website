...
function animateTiles(tile, xPos, zPos, yRot){
    gsap.to(tile.mesh.position, { duration: 0.8, delay: 0, ease: "power2", x: distances.x * xPos})
    gsap.to(tile.mesh.position, { duration: 0.8, delay: 0, ease: "power2", z: distances.z * zPos})
    gsap.to(tile.mesh.rotation, { duration: 0.8, delay: 0, ease: "power2", y: distances.rY * yRot})
}

function animateTilesSlowly(tile, xPos, zPos, yRot, dur, del, func){
    gsap.to(tile.mesh.position, { duration: dur, delay: del, ease: "power2", x: distances.x * xPos, onComplete: func})
    gsap.to(tile.mesh.position, { duration: dur, delay: del, ease: "power2", z: distances.z * zPos})
    gsap.to(tile.mesh.rotation, { duration: dur, delay: del, ease: "power2", y: distances.rY * yRot})
}
